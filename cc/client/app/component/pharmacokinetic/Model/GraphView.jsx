...
import { createCompartment } from './CompartmentControl';
import { ModelEvents } from '../../modelMixin';

export const GraphViewBuilder = ({ modelType = 'pharmacokinetic' } = {}) => {
  ...
  const actions = (props, reference) => {
    const {
      ...
      user,
      actions,
      selected: { Compartment: compartment, LearningActivity: learningActivity },
      subSelected,
    } = props;
    let editable = props;
