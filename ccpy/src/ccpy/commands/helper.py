...
from ccpy.model         	import Registry
from ccpy.commands.util 	import cli_format
from ccpy.table      	  	import Table
from ccpy.tree			import Node as TreeNode
from ccpy.util.string     import pluralize, strip
from ccpy.util.system   	import read, write, popen, which
from ccpy.util.array		import squash
from ccpy 		      	import (_pip, cli, semver,
	log, parallel
)
...
def get_registry_from_pip(pip_path, user = False, sync = False, outdated = True,
	...
	# _pip.get_installed_distributions() # https://github.com/achillesrasquinha/ccpy/issues/13
