...
from ccpy             import __name__ as NAME, __version__
from ccpy.util.system import pardir, makedirs, touch
from ccpy.util.types  import auto_typecast
from ccpy.util._dict  import autodict
from ccpy._compat     import iteritems, configparser as cp
