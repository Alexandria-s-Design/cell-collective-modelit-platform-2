...
from ccpy.request.response import Response
from ccpy.util.string      import safe_encode
from ccpy.log              import get_logger

logger = get_logger()

# YAGNI: This patched "requests" works only for ccpy's use-cases.
