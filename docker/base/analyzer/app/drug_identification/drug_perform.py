...
from ..schemas import DrugAnalyzerBody
...
# 			"maxrows": 2000,
#				"result_dir": "/uploads/20230701"
#				"tmp_dir": "/tmp/20230701"
# 	}

def perform_diff_gene(str_jsondata: DrugAnalyzerBody):

		# data = json.loads(str_jsondata)

		# Get the parameters
		csv_healthy_counts = str_jsondata.healthy
		csv_diseased_counts = str_jsondata.diseased
		max_rows = str_jsondata.maxrows
		method_perform = str_jsondata.method
		statis_perform = str_jsondata.statistical
		tmp_dir = str_jsondata.tmp_dir
		result_dir = str_jsondata.result_dir
		...
		if not os.path.exists(result_dir):
				raise ValueError("Please inform a valid [result_dir] key on your JSON input")
